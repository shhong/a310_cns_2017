...
Demo of a network of two spiking neurons driven by synaptic inputs.
...
nc12 = h.NetCon(cell1['soma'](0.5)._ref_v, cell2['syns'][-1], sec=cell1['soma'])
nc12.threshold = -50
nc12.weight[0] = 50e-3 # This one is big!
